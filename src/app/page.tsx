      ...
      <section className="mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-6 py-20">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-3">
          <InfoCard
            ...
            description="Turn customer inquiries into summaries, reply drafts, follow-up actions, and pipeline status."
          />

          <InfoCard
            title="HR Workflow Assistant"
            description="Organize candidate data, CV summaries, interview preparation, and onboarding tasks."
          />

          <InfoCard
            title="Document Intake Assistant"
            description="Extract fields, summarize documents, generate checklists, and show human-review warnings."
          />
        </div>
